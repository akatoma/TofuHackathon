...
static WelcomeWindow()
        ...
        void OnEnable()
        {
            banner = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/ArtStore3D/Insurgent Lite(LITE)/Editor/Images/ArtStore3D.png");
            tonIcon = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/ArtStore3D/Insurgent Lite(LITE)/Editor/Images/Ton.png");
            usdtIcon = AssetDatabase.LoadAssetAtPath<Texture2D>("Assets/ArtStore3D/Insurgent Lite(LITE)/Editor/Images/USDTRC20.png");
...
string supportText = "Your support ensures the continued growth and quality of this project. If you find this asset valuable, here are a few ways to assist our development:\n\n" +
        ...
        GUILayout.Label(supportText, textStyle);
            ...
            if (GUILayout.Button("Support by Rating & Reviewing", GUILayout.Height(30)))
                Application.OpenURL("https://u3d.as/3dth");
